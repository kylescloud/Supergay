...
import { AAVE_V3_POOL } from '../src/config/constants';
...
async function main() {
  ...
  console.log('- Min Profit:', ethers.formatEther(pool._minProfit), 'ETH');
  ...
  console.log('\nApproving WETH...');
  const approveTx = await weth.approve(contractAddress, ethers.MaxUint256);
